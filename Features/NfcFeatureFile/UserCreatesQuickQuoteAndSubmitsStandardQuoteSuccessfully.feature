...
##| seema.chaple | Happywork@98 | Finance Leases Program     | TRAC Lease    | Status : Application Submitted |
#| seema.chaple | Happywork@98 | Credit Line Lease Takedown | Finance Lease | Status : Credit Line Takedown Submitted |
...
#Examples:
#	| Username     | Password     | Program                    | Product               | Status                                      |
#	| seema.chaple | Happywork@98 | FMV Program                | Operating Lease       | Status : Application Submitted              |
#	| seema.chaple | Happywork@98 | Credit Line Lease Takedown | Operating Lease       | Status : Credit Line Takedown Submitted     |



@Sanity
Scenario Outline: Program : IdealLease And Product : Idealease
	#Given the user is on the login page
	#When the user enters "<Username>" and "<Password>" and clicks on the Login button
	Then the user should be successfully redirected to the dashboard page
	When the user clicks on Create Quick Quote
...
Examples:
	...
	@Sanity
Scenario Outline: Program: Finance Leases Program And Product : Finance Lease
	#Given the user is on the login page
	#When the user enters "<Username>" and "<Password>" and clicks on the Login button
	Then the user should be successfully redirected to the dashboard page
	When the user clicks on Create Quick Quote
...
Examples:
	...
	@Sanity
Scenario Outline: Program : Finance Leases  And Product: TRAC Lease
	#Given the user is on the login page
	#When the user enters "<Username>" and "<Password>" and clicks on the Login button
	Then the user should be successfully redirected to the dashboard page
	When the user clicks on Create Quick Quote
...
Examples:
	| Username        | Password     | Program                    | Product       | AfterContractStatus            | BeforeContractStatus |
	| sandeep.bedekar | Testing@2211 | Finance Leases Program     | TRAC Lease    | Status : Application Submitted | Status : Quote       |




	@Sanity
Scenario Outline: Program: Credit Line Lease Takedown  and Product : Finance Lease
	#Given the user is on the login page
	#When the user enters "<Username>" and "<Password>" and clicks on the Login button
	Then the user should be successfully redirected to the dashboard page
	When the user clicks on Create Quick Quote
...
Examples:
	| Username        | Password     | Program                    | Product       | AfterContractStatus                     | BeforeContractStatus            |
	| sandeep.bedekar | Testing@2211 | Credit Line Lease Takedown | Finance Lease | Status : Credit Line Takedown Submitted | Status : Quote from Credit Line |




	@Sanity
Scenario Outline: Program: Credit Line Lease Takedown  and Product : TRAC Lease
	#Given the user is on the login page
	#When the user enters "<Username>" and "<Password>" and clicks on the Login button
	Then the user should be successfully redirected to the dashboard page
	When the user clicks on Create Quick Quote
...
Examples:
	| Username        | Password     | Program                    | Product       | AfterContractStatus                     | BeforeContractStatus            |
	| sandeep.bedekar | Testing@2211 | Credit Line Lease Takedown | TRAC Lease    | Status : Credit Line Takedown Submitted | Status : Quote from Credit Line |




	@Sanity
Scenario Outline: Program: Loan Program  And Product : Finance Included Loan
	#Given the user is on the login page
	#When the user enters "<Username>" and "<Password>" and clicks on the Login button
	Then the user should be successfully redirected to the dashboard page
	When the user clicks on Create Quick Quote
...
Examples:
	| Username        | Password     | Program      | Product               | AfterContractStatus            | BeforeContractStatus |
	| sandeep.bedekar | Testing@2211 | Loan Program | Finance Included Loan | Status : Application Submitted | Status : Quote                    |



	
	@Sanity
Scenario Outline: Program: Credit Line Loan Takedown  And Product : Finance Included Loan
	#Given the user is on the login page
	#When the user enters "<Username>" and "<Password>" and clicks on the Login button
	Then the user should be successfully redirected to the dashboard page
	When the user clicks on Create Quick Quote
...
Examples:
	| Username        | Password     | Program                   | Product               | AfterContractStatus                     | BeforeContractStatus |
	| sandeep.bedekar | Testing@2211 | Credit Line Loan Takedown | Finance Included Loan | Status : Credit Line Takedown Submitted |  Status : Quote from Credit Line                    |


	
	@Sanity
Scenario Outline: Program: IdeaLease Program  And Product : Finance Included Loan
	#Given the user is on the login page
	#When the user enters "<Username>" and "<Password>" and clicks on the Login button
	Then the user should be successfully redirected to the dashboard page
	When the user clicks on Create Quick Quote
...
Examples:
	| Username        | Password     | Program           | Product               | AfterContractStatus                     | BeforeContractStatus            |
	| sandeep.bedekar | Testing@2211 | IdeaLease Program | Finance Included Loan | Status : Credit Line Takedown Submitted | Status : Quote from Credit Line |




	@Sanity
Scenario Outline: Program : IdealLease And Product : Finance Included Loan
	#Given the user is on the login page
	#When the user enters "<Username>" and "<Password>" and clicks on the Login button
	Then the user should be successfully redirected to the dashboard page
	When the user clicks on Create Quick Quote
...
Examples:
	...
	@Sanity
Scenario Outline: Program : FMV Program And Product : Operating Lease
	#Given the user is on the login page
	#When the user enters "<Username>" and "<Password>" and clicks on the Login button
	Then the user should be successfully redirected to the dashboard page
	When the user clicks on Create Quick Quote
...
Examples:
	| Username        | Password     | Program           | Product               | AfterContractStatus                     | BeforeContractStatus    |
	| seema.chaple    | Happywork@98 | FMV Program       | Operating Lease       | Status : Application Submitted          | Status : Quote           |
		...
		@Sanity
Scenario Outline: Program : Credit Line Lease Takedown And Product : Operating Lease
	# Given the user is on the login page
	# When the user enters "<Username>" and "<Password>" and clicks on the Login button
	Then the user should be successfully redirected to the dashboard page
	When the user clicks on Create Quick Quote
...
Examples:
	| Username        | Password     | Program                    | Product               | AfterContractStatus                         | BeforeContractStatus                 |
	| sandeep.bedekar | Testing@2211 | Credit Line Lease Takedown | Operating Lease       | Status : Credit Line Takedown Submitted     | Status : Quote from Credit Line      |