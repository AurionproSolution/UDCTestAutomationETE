...
test('test', async ({ page }) => {
  ...
  await page.getByRole('textbox', { name: 'Asset Value* Sum Insured Net' }).fill('');
  const asset = page.getByRole('textbox', { name: 'Asset Value* Sum Insured Net' });
  await asset.click();
  ...
  await page.locator('text').filter({ hasText: 'Last Name' }).locator('#text').fill('Mote');
  await page.getByRole('button', { name: 'Choose Date' }).click();
  await page.getByRole('gridcell', { name: '10' }).click();
  await page.getByRole('button', { name: 'Search' }).click();
  await page.getByRole('button', { name: ' Add New Customer' }).click();
  await page.locator(`//span//label[contains(text(), 'Title')]/following-sibling::div//span`).click();
  await page.getByRole('option', { name: 'Mr', exact: true }).click();
  await page.locator(`//span//label[contains(text(), 'Gender')]/following-sibling::div//span`).click();
  await page.getByRole('option', { name: 'Male', exact: true }).click();
  await page.locator(`//span//label[contains(text(), 'Marital Status')]/following-sibling::div//span`).click();
  await page.getByRole('option', { name: 'Married', exact: true }).click();
  await page.locator(`//span//label[contains(text(), 'No. of Dependants')]/following-sibling::div//span`).click();
  ...
  await page.locator('app-personal-detail-email-contact input[type="text"]').click();
  await page.locator('app-personal-detail-email-contact input[type="text"]').fill('test@gmail.com');
  ...
  await page.locator('#pn_id_1149').getByRole('button', { name: 'dropdown trigger' }).click();
  await page.getByRole('option', { name: 'Boarding' }).click();
  await page.locator('number').filter({ hasText: 'Time at Address' }).getByRole('spinbutton').click();
  await page.locator('.col.mt-3').first().click();
  await page.getByRole('textbox', { name: 'Building Name Floor Number' }).click();
  await page.getByRole('textbox', { name: 'Building Name Floor Number' }).fill('a');
  await page.locator('#pn_id_1155').getByRole('button', { name: 'dropdown trigger' }).click();
  await page.getByRole('option', { name: 'Floor' }).click();
  await page.locator('#text').nth(1).click();
  await page.locator('#text').nth(1).fill('1');
  await page.locator('#pn_id_1159').getByRole('button', { name: 'dropdown trigger' }).click();
  ...
  await page.getByRole('textbox', { name: 'Employer Name* Time with' }).fill('REWQ');
  await page.locator('#pn_id_1244').getByRole('button', { name: 'dropdown trigger' }).click();
  await page.getByRole('option', { name: 'Accountant' }).click();
  await page.locator('#pn_id_1247').getByRole('button', { name: 'dropdown trigger' }).click();
  await page.getByText('Casually employed').click();
  await page.locator('text').filter({ hasText: 'Time with Current Employer' }).locator('#text').click();
  await page.locator('text').filter({ hasText: 'Time with Current Employer' }).locator('#text').fill('1');
  ...
  await page.locator('#pn_id_1253').getByRole('button', { name: 'dropdown trigger' }).click();
  ...
  await page.locator('.regular-recurring-details-form > .grid > div:nth-child(2) > amount > .p-field > p-floatlabel > .p-float-label > #amount').click();
  await page.locator('.regular-recurring-details-form > .grid > div:nth-child(2) > amount > .p-field > p-floatlabel > .p-float-label > #amount').click();
  await page.locator('.regular-recurring-details-form > .grid > div:nth-child(2) > amount > .p-field > p-floatlabel > .p-float-label > #amount').press('ArrowRight');
  await page.getByRole('button', { name: 'Next' }).click();
  ...
  await page.locator('#pn_id_1398').getByRole('button', { name: 'dropdown trigger' }).click();
  await page.getByRole('option', { name: 'Accountant' }).click();
  await page.locator('#pn_id_1401').getByRole('button', { name: 'dropdown trigger' }).click();
  await page.getByText('Full time employed').click();
  await page.getByRole('button', { name: 'Next' }).click();
  await page.locator('.ng-pristine.ng-invalid > .p-field > p-floatlabel > .p-float-label > #amount').click();
  await page.getByRole('button', { name: 'Next' }).click();
  await page.getByText('Address Details').click();
  await page.locator('.p-element.valueClass.ng-untouched.ng-pristine.ng-invalid > .p-inputswitch > .p-inputswitch-slider').click();
  await page.locator('.p-inputswitch.p-component.p-inputswitch-checked > .p-inputswitch-slider').click();
  await page.locator('input[name="previousSearchValue"]').click();
  await page.locator('input[name="previousSearchValue"]').fill('auck');
  await page.getByRole('option', { name: '2 Auckland Road, St Heliers,' }).click();
  await page.getByRole('button', { name: 'Next' }).click();
  await page.getByText('Reference Details').click();
  await page.locator('.p-checkbox-box').click();
  await page.getByRole('button', { name: 'Submit' }).click();
  await page.goto('https://testportaludc.aurionpro.com/dealer/standard-quote/edit/5161');
