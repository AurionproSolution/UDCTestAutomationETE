...
See [ONBOARDING.md](../ONBOARDING.md) for the full checklist.
...
**Reference implementation:** [examples/udc-blueprint.md](../examples/udc-blueprint.md).
...
- Blueprint template: [templates/automation-blueprint.md](../templates/automation-blueprint.md)
- UDC reference blueprint: [examples/udc-blueprint.md](../examples/udc-blueprint.md)
- Playwright + Cursor basics: ask your team lead for internal beginner guide if available
- Onboarding checklist: [ONBOARDING.md](../ONBOARDING.md)
